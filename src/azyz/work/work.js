...
// import Header from "./workjsx/header";
import Sider from "./workjsx/sider";

import Add from "./workjsx/add";
import MyApp from "./workjsx/myapp";
import Market from "./workjsx/market";
import GetInfo from "./workjsx/myappcomponent/getInfo";
import MyLike from "./workjsx/mylike";
import MyWallet from "./workjsx/mywallet";
import Test from "./workjsx/test";
